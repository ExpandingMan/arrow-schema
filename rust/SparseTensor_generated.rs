...
#[allow(non_camel_case_types)]
pub const ENUM_NAMES_SPARSE_MATRIX_COMPRESSED_AXIS:[&'static str; 2] = [
    "Row",
    "Column"
];

pub fn enum_name_sparse_matrix_compressed_axis(e: SparseMatrixCompressedAxis) -> &'static str {
  let index = e as i16;
...
#[allow(non_camel_case_types)]
pub const ENUM_NAMES_SPARSE_TENSOR_INDEX:[&'static str; 4] = [
    "NONE",
...
impl<'a> SparseTensorIndexCOO<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args SparseTensorIndexCOOArgs<'args>) -> flatbuffers::WIPOffset<SparseTensorIndexCOO<'bldr>> {
  ...
  pub fn indicesType(&self) -> Int<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Int<'a>>>(SparseTensorIndexCOO::VT_INDICESTYPE, None).unwrap()
  }
  /// Non-negative byte offsets to advance one value cell along each dimension
  /// If omitted, default to row-major order (C-like).
  #[inline]
  pub fn indicesStrides(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(SparseTensorIndexCOO::VT_INDICESSTRIDES, None)
  }
  /// The location and size of the indices matrix's data
  #[inline]
  pub fn indicesBuffer(&self) -> &'a Buffer {
    self._tab.get::<Buffer>(SparseTensorIndexCOO::VT_INDICESBUFFER, None).unwrap()
  }
}
...
impl<'a: 'b, 'b> SparseTensorIndexCOOBuilder<'a, 'b> {
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<SparseTensorIndexCOO<'a>> {
    ...
    self.fbb_.required(o, SparseTensorIndexCOO::VT_INDICESTYPE,"indices_type");
    self.fbb_.required(o, SparseTensorIndexCOO::VT_INDICESBUFFER,"indices_buffer");
...
impl<'a> SparseMatrixIndexCSX<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args SparseMatrixIndexCSXArgs<'args>) -> flatbuffers::WIPOffset<SparseMatrixIndexCSX<'bldr>> {
  ...
  pub fn compressedAxis(&self) -> SparseMatrixCompressedAxis {
    self._tab.get::<SparseMatrixCompressedAxis>(SparseMatrixIndexCSX::VT_COMPRESSEDAXIS, Some(SparseMatrixCompressedAxis::Row)).unwrap()
  }
  /// The type of values in indptrBuffer
  #[inline]
  pub fn indptrType(&self) -> Int<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Int<'a>>>(SparseMatrixIndexCSX::VT_INDPTRTYPE, None).unwrap()
  }
  ...
  pub fn indptrBuffer(&self) -> &'a Buffer {
    self._tab.get::<Buffer>(SparseMatrixIndexCSX::VT_INDPTRBUFFER, None).unwrap()
  }
  /// The type of values in indicesBuffer
  #[inline]
  pub fn indicesType(&self) -> Int<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Int<'a>>>(SparseMatrixIndexCSX::VT_INDICESTYPE, None).unwrap()
  }
  ...
  #[inline]
  pub fn indicesBuffer(&self) -> &'a Buffer {
    self._tab.get::<Buffer>(SparseMatrixIndexCSX::VT_INDICESBUFFER, None).unwrap()
  }
}
...
impl<'a: 'b, 'b> SparseMatrixIndexCSXBuilder<'a, 'b> {
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<SparseMatrixIndexCSX<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, SparseMatrixIndexCSX::VT_INDPTRTYPE,"indptr_type");
    self.fbb_.required(o, SparseMatrixIndexCSX::VT_INDPTRBUFFER,"indptr_buffer");
    self.fbb_.required(o, SparseMatrixIndexCSX::VT_INDICESTYPE,"indices_type");
    self.fbb_.required(o, SparseMatrixIndexCSX::VT_INDICESBUFFER,"indices_buffer");
    flatbuffers::WIPOffset::new(o.value())
  }
}
...
impl<'a> SparseTensorIndexCSF<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args SparseTensorIndexCSFArgs<'args>) -> flatbuffers::WIPOffset<SparseTensorIndexCSF<'bldr>> {
  ...
  #[inline]
  pub fn indptrType(&self) -> Int<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Int<'a>>>(SparseTensorIndexCSF::VT_INDPTRTYPE, None).unwrap()
  }
  ...
  pub fn indptrBuffers(&self) -> &'a [Buffer] {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<Buffer>>>(SparseTensorIndexCSF::VT_INDPTRBUFFERS, None).map(|v| v.safe_slice() ).unwrap()
  }
  /// The type of values in indicesBuffers
  #[inline]
  pub fn indicesType(&self) -> Int<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Int<'a>>>(SparseTensorIndexCSF::VT_INDICESTYPE, None).unwrap()
  }
  ...
  pub fn indicesBuffers(&self) -> &'a [Buffer] {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<Buffer>>>(SparseTensorIndexCSF::VT_INDICESBUFFERS, None).map(|v| v.safe_slice() ).unwrap()
  }
  ...
  pub fn axisOrder(&self) -> flatbuffers::Vector<'a, i32> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i32>>>(SparseTensorIndexCSF::VT_AXISORDER, None).unwrap()
  }
}
...
impl<'a: 'b, 'b> SparseTensorIndexCSFBuilder<'a, 'b> {
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<SparseTensorIndexCSF<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, SparseTensorIndexCSF::VT_INDPTRTYPE,"indptr_type");
    self.fbb_.required(o, SparseTensorIndexCSF::VT_INDPTRBUFFERS,"indptr_buffers");
    self.fbb_.required(o, SparseTensorIndexCSF::VT_INDICESTYPE,"indices_type");
    self.fbb_.required(o, SparseTensorIndexCSF::VT_INDICESBUFFERS,"indices_buffers");
    self.fbb_.required(o, SparseTensorIndexCSF::VT_AXISORDER,"axis_order");
    flatbuffers::WIPOffset::new(o.value())
  }
}
...
impl<'a> SparseTensor<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args SparseTensorArgs<'args>) -> flatbuffers::WIPOffset<SparseTensor<'bldr>> {
  ...
  pub fn type_type(&self) -> Type {
    self._tab.get::<Type>(SparseTensor::VT_TYPE_TYPE, Some(Type::NONE)).unwrap()
  }
  ...
  pub fn type_(&self) -> flatbuffers::Table<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(SparseTensor::VT_TYPE_, None).unwrap()
  }
  /// The dimensions of the tensor, optionally named.
  #[inline]
  pub fn shape(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TensorDim<'a>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<flatbuffers::ForwardsUOffset<TensorDim<'a>>>>>(SparseTensor::VT_SHAPE, None).unwrap()
  }
  /// The number of non-zero values in a sparse tensor.
  #[inline]
  pub fn non_zero_length(&self) -> i64 {
    self._tab.get::<i64>(SparseTensor::VT_NON_ZERO_LENGTH, Some(0)).unwrap()
  }
  #[inline]
  pub fn sparseIndex_type(&self) -> SparseTensorIndex {
    self._tab.get::<SparseTensorIndex>(SparseTensor::VT_SPARSEINDEX_TYPE, Some(SparseTensorIndex::NONE)).unwrap()
  }
  /// Sparse tensor index
  #[inline]
  pub fn sparseIndex(&self) -> flatbuffers::Table<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(SparseTensor::VT_SPARSEINDEX, None).unwrap()
  }
  /// The location and size of the tensor's data
  #[inline]
  pub fn data(&self) -> &'a Buffer {
    self._tab.get::<Buffer>(SparseTensor::VT_DATA, None).unwrap()
  }
  #[inline]
  ...
  pub fn sparseIndex_as_sparse_tensor_index_coo(&self) -> Option<SparseTensorIndexCOO<'a>> {
    if self.sparseIndex_type() == SparseTensorIndex::SparseTensorIndexCOO {
      self.sparseIndex().map(|u| SparseTensorIndexCOO::init_from_table(u))
    } else {
      None
    }
  }
  ...
  pub fn sparseIndex_as_sparse_matrix_index_csx(&self) -> Option<SparseMatrixIndexCSX<'a>> {
    if self.sparseIndex_type() == SparseTensorIndex::SparseMatrixIndexCSX {
      self.sparseIndex().map(|u| SparseMatrixIndexCSX::init_from_table(u))
    } else {
      None
    }
  }
  ...
  pub fn sparseIndex_as_sparse_tensor_index_csf(&self) -> Option<SparseTensorIndexCSF<'a>> {
    if self.sparseIndex_type() == SparseTensorIndex::SparseTensorIndexCSF {
      self.sparseIndex().map(|u| SparseTensorIndexCSF::init_from_table(u))
    } else {
      None
    }
  }
...
impl<'a: 'b, 'b> SparseTensorBuilder<'a, 'b> {
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<SparseTensor<'a>> {
    ...
    self.fbb_.required(o, SparseTensor::VT_SPARSEINDEX,"sparse_index");
