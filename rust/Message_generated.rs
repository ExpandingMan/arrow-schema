...
#[allow(non_camel_case_types)]
pub const ENUM_NAMES_COMPRESSION_TYPE:[&'static str; 2] = [
    "LZ4_FRAME",
    "ZSTD"
];
...
#[allow(non_camel_case_types)]
pub const ENUM_NAMES_BODY_COMPRESSION_METHOD:[&'static str; 1] = [
    "BUFFER"
];
...
#[allow(non_camel_case_types)]
pub const ENUM_NAMES_MESSAGE_HEADER:[&'static str; 6] = [
    "NONE",
    "Schema",
    "DictionaryBatch",
    "RecordBatch",
...
impl<'a> RecordBatch<'a> {
  ...
  pub fn compression(&self) -> Option<BodyCompression<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<BodyCompression<'a>>>(RecordBatch::VT_COMPRESSION, None)
  }
}
...
impl<'a> Message<'a> {
  ...
  pub fn custom_metadata(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<KeyValue<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<flatbuffers::ForwardsUOffset<KeyValue<'a>>>>>(Message::VT_CUSTOM_METADATA, None)
  }
  #[inline]
