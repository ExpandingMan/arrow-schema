...
pub const ENUM_MAX_METADATA_VERSION: i16 = 3;
...
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_METADATA_VERSION:[MetadataVersion; 4] = [
  MetadataVersion::V1,
  MetadataVersion::V2,
  MetadataVersion::V3,
  MetadataVersion::V4
...
#[allow(non_camel_case_types)]
pub const ENUM_NAMES_METADATA_VERSION:[&'static str; 4] = [
    "V1",
    "V2",
    "V3",
    "V4"
...
#[allow(non_camel_case_types)]
pub const ENUM_NAMES_UNION_MODE:[&'static str; 2] = [
    "Sparse",
    "Dense"
];
...
#[allow(non_camel_case_types)]
pub const ENUM_NAMES_PRECISION:[&'static str; 3] = [
    "HALF",
    "SINGLE",
    "DOUBLE"
];
...
#[allow(non_camel_case_types)]
pub const ENUM_NAMES_DATE_UNIT:[&'static str; 2] = [
    "DAY",
    "MILLISECOND"
];
...
#[allow(non_camel_case_types)]
pub const ENUM_NAMES_TIME_UNIT:[&'static str; 4] = [
    "SECOND",
    "MILLISECOND",
    "MICROSECOND",
    "NANOSECOND"
...
#[allow(non_camel_case_types)]
pub const ENUM_NAMES_INTERVAL_UNIT:[&'static str; 2] = [
    "YEAR_MONTH",
    "DAY_TIME"
];
...
#[allow(non_camel_case_types)]
pub const ENUM_NAMES_TYPE:[&'static str; 22] = [
    "NONE",
    "Null",
    "Int",
    "FloatingPoint",
...
#[allow(non_camel_case_types)]
pub const ENUM_NAMES_DICTIONARY_KIND:[&'static str; 1] = [
    "DenseArray"
];
...
#[allow(non_camel_case_types)]
pub const ENUM_NAMES_ENDIANNESS:[&'static str; 2] = [
    "Little",
    "Big"
];
